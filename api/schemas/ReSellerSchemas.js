const ReSellerSchemas = {
  validator: {
    name: "required|alphaspace|minLength:2|maxLength:50|isUnique:ReSeller/ReSeller,name",
    gst_number: "string",
    pan_number: "string",
    contact_person_name: "alphaspace",
    email_id: "required|email|isUnique:ReSeller/ReSeller,email_id",
    ...
    primary_contact_number:
      "required|integer|isUnique:ReSeller/ReSeller,primary_contact_number",
    primary_contact_id: "integer|isExists:Master/Country",
    alternate_contact_number:
      "integer|isUnique:ReSeller/ReSeller,alternate_contact_number",
