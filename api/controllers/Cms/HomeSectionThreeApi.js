...
const { HomeSectionThree } = require("../../schemas/CmsSchemas");

const validationService = require("../../services/validation.service");
const Product = require("../../models/Product/Product");

const HomeSectionThreeApi = () => {
    ...
    const save = async (req, res) => {
        ...
        validationService
            .validate(req.body, HomeSectionThree)
            .then(async (reqData) => {
                try {
                    let response;
                    if (reqData.id) {
                        response = await crudService.update(
                            HomeSectionThreeModel,
                            {
                                id: reqData.id,
                            },
                            reqData
        ...
        try {
            if (req.body.record_id) {
                for (let id of req.body.record_id) {
                    let response = await crudService.destroy(HomeSectionThreeModel, {
                        id: id,
                    });
                }
    ...
    const get = async (req, res) => {
        try {
            ...
            response = await crudService.getAll(HomeSectionThreeModel, {
                where: whereClause,
...
module.exports = HomeSectionThreeApi;
